...
pub fn create_router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/api/conversation/:id/stream", get(stream_conversation))
        // User actions (REQ-API-004)
        .route("/api/conversation/:id/chat", post(send_chat))
        ...
        .route("/api/conversation-by-slug/:slug", get(get_by_slug))
