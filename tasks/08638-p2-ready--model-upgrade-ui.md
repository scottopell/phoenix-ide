...
- [ ] User can upgrade from 200k to 1M variant from the UI
- [ ] User can switch models on an idle conversation
- [ ] Context window display reflects the upgraded model
- [ ] Upgrade is disabled when conversation is not idle
