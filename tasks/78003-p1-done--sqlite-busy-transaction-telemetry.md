...
Make writer contention diagnosable without inferring lock ownership from SQLx elapsed time. Add structured database telemetry that records SQLite primary and extended result codes, operation identity, elapsed duration, and transaction phase (acquisition, statement, or commit) for critical writes and FTS maintenance.
