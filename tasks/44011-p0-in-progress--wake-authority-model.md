...
Codex reviewed the evolving foundation in twenty rounds and reported seventy-eight actionable threads. The comments were not independent edge cases; they exposed five missing boundary statements now made explicit above.
...
| Generic workflow storage is not wake semantic authority | `PRRT_kwDORKxuOM6XHG64`, `PRRT_kwDORKxuOM6XIsGt`, `PRRT_kwDORKxuOM6XJAzg`, `PRRT_kwDORKxuOM6XXdrg` | Generic creation, transition, delivery, and receipt wrappers reject wake profiles; wake repository operations derive writes from loaded aggregate state. | Generic creation/wrapper/receipt rejection and projection-consistency tests |
| IDs and transferability are not authorization | `PRRT_kwDORKxuOM6XHG6-`, `PRRT_kwDORKxuOM6XHG7A`, `PRRT_kwDORKxuOM6XHw-O`, `PRRT_kwDORKxuOM6XINFD`, `PRRT_kwDORKxuOM6XJAzT`, `PRRT_kwDORKxuOM6XJAzm`, `PRRT_kwDORKxuOM6XL19Q`, `PRRT_kwDORKxuOM6XL19Z`, `PRRT_kwDORKxuOM6XLKW3`, `PRRT_kwDORKxuOM6XW5Oo`, `PRRT_kwDORKxuOM6XXMt4`, `PRRT_kwDORKxuOM6XXdrb` | Registration, observation, reconciliation, transfer, and workflow allocation require resource/repository authority rather than caller-selected identifiers; registration retries recover the existing contract binding and effect IDs are range-bounded. | Crossed/stale capability, exact registration replay, shared-sequence, and transition/effect-ID bound tests |
| Persisted events, effects, and types must be total | `PRRT_kwDORKxuOM6XHG67`, `PRRT_kwDORKxuOM6XHG6_`, `PRRT_kwDORKxuOM6XHw-Q`, `PRRT_kwDORKxuOM6XHw-U`, `PRRT_kwDORKxuOM6XHw-X`, `PRRT_kwDORKxuOM6XIsGo`, `PRRT_kwDORKxuOM6XJAza`, `PRRT_kwDORKxuOM6XK9Xj`, `PRRT_kwDORKxuOM6XL19P`, `PRRT_kwDORKxuOM6XL19T`, `PRRT_kwDORKxuOM6XLKWz`, `PRRT_kwDORKxuOM6XLKW6` | Registration events retain transfer policy; effect intents round-trip for restart decoding; closed enums and duration bounds match SQL; nominal identities reject SQL-invalid values before transition. | Event/effect rebuildability, serde rejection, relational-bound, and migration tests |
| Cancellation/expiry fencing is an internal transaction protocol | `PRRT_kwDORKxuOM6XHw-L`, `PRRT_kwDORKxuOM6XINFA`, `PRRT_kwDORKxuOM6XJAzt`, `PRRT_kwDORKxuOM6XKbXn`, `PRRT_kwDORKxuOM6XK9XU`, `PRRT_kwDORKxuOM6XK9XW`, `PRRT_kwDORKxuOM6XW5Oj`, `PRRT_kwDORKxuOM6XW5Op` | Fence acknowledgement creates no reducer delivery and rejected acknowledgement rolls back every mutation; the receipt gates only proposal finalization; all fired or forgotten evidence must precede both proposal cutoff and contract deadline, including observations received before the expiry command. | Fence lifecycle, rollback, no-delivery, deadline, and occurrence-precedence tests |
| Generic delivery schema and wake ownership are separate dimensions | `PRRT_kwDORKxuOM6XIsGu`, `PRRT_kwDORKxuOM6XK9Xi` | Generic `consumer_kind` remains the supported `reducer` discriminator; mutable wake delivery ownership stays in the normalized wake authority row and terminal event. | Terminal bundle insertion and delivery-owner projection tests |
| Replay validates the obligations created by each transition | `PRRT_kwDORKxuOM6XLKW0`, `PRRT_kwDORKxuOM6XYF4n`, `PRRT_kwDORKxuOM6XYF4r`, `PRRT_kwDORKxuOM6XYWoF`, `PRRT_kwDORKxuOM6XYgCR`, `PRRT_kwDORKxuOM6XYgCY`, `PRRT_kwDORKxuOM6XYgCb`, `PRRT_kwDORKxuOM6XYtSU`, `PRRT_kwDORKxuOM6XYtSW`, `PRRT_kwDORKxuOM6XY-Wd`, `PRRT_kwDORKxuOM6XY-Wg`, `PRRT_kwDORKxuOM6XY-Wm` | Replaying a post-terminal owner transfer validates its transfer effect at the current head and the unique terminal bundle at the earlier terminal transition; advancing ownership cannot make the existing delivery bundle appear absent. | Applied-and-replayed closed-transfer repository regression |
| Observation effects are long-lived authority, not repeatable commands | `PRRT_kwDORKxuOM6XKbXz`, `PRRT_kwDORKxuOM6XL19M`, `PRRT_kwDORKxuOM6XLKWx`, `PRRT_kwDORKxuOM6XW5Od`, `PRRT_kwDORKxuOM6XW5Oh`, `PRRT_kwDORKxuOM6XXMt2`, `PRRT_kwDORKxuOM6XXMt7`, `PRRT_kwDORKxuOM6XXdrX`, `PRRT_kwDORKxuOM6XXdre`, `PRRT_kwDORKxuOM6XXdrj`, `PRRT_kwDORKxuOM6XXto3`, `PRRT_kwDORKxuOM6XXto5`, `PRRT_kwDORKxuOM6XXto9`, `PRRT_kwDORKxuOM6XX263`, `PRRT_kwDORKxuOM6XX267`, `PRRT_kwDORKxuOM6XYF4g`, `PRRT_kwDORKxuOM6XYF4m`, `PRRT_kwDORKxuOM6XYWn_`, `PRRT_kwDORKxuOM6XYWoK`, `PRRT_kwDORKxuOM6XYgCe`, `PRRT_kwDORKxuOM6XYtSZ` | Begin-observation and fence effects use reclaimable-observation capability so lease expiry/restart adopts the same observation identity rather than spawning an untracked duplicate; deterministic terminalization/transfer bookkeeping remains safely repeatable. | Persisted effect-capability assertion and generic attempt/reclaim tests |
| Restart reconciliation is distinct from a live observation attempt | `PRRT_kwDORKxuOM6XK9Xa` | Live protocol failures remain attempt-bound and deadline-limited; restart/resource-unevaluable evidence uses a sealed recovery capability and may settle `Forgotten` after the deadline without reviving a fenced attempt. | Crossed recovery authority, post-deadline forgotten, and repository restart tests |
...
- The seventy-eight Codex foundation findings are mapped to decisions and evidence; a fresh exact-head Codex review must produce no actionable thread (👍).
