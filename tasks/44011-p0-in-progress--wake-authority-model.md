...
| Replay validates the obligations created by each transition | `PRRT_kwDORKxuOM6XLKW0`, `PRRT_kwDORKxuOM6XYGRp`, `PRRT_kwDORKxuOM6XYGRu` | Replaying a post-terminal owner transfer validates its transfer effect at the current head and the unique terminal bundle at the earlier terminal transition; advancing ownership cannot make the existing delivery bundle appear absent. | Applied-and-replayed closed-transfer repository regression |
| Observation effects are long-lived authority, not repeatable commands | `PRRT_kwDORKxuOM6XKbXz`, `PRRT_kwDORKxuOM6XL19M`, `PRRT_kwDORKxuOM6XLKWx`, `PRRT_kwDORKxuOM6XW5Od`, `PRRT_kwDORKxuOM6XW5Oh`, `PRRT_kwDORKxuOM6XXMt2`, `PRRT_kwDORKxuOM6XXMt7`, `PRRT_kwDORKxuOM6XXdrX`, `PRRT_kwDORKxuOM6XXdre`, `PRRT_kwDORKxuOM6XXdrj`, `PRRT_kwDORKxuOM6XXto3`, `PRRT_kwDORKxuOM6XXto5`, `PRRT_kwDORKxuOM6XXto9`, `PRRT_kwDORKxuOM6XX263`, `PRRT_kwDORKxuOM6XX267`, `PRRT_kwDORKxuOM6XYGRk`, `PRRT_kwDORKxuOM6XYGRl` | Begin-observation and fence effects use reclaimable-observation capability so lease expiry/restart adopts the same observation identity rather than spawning an untracked duplicate; deterministic terminalization/transfer bookkeeping remains safely repeatable. | Persisted effect-capability assertion and generic attempt/reclaim tests |
