...
struct MessageView: View {
    ...
    private var noteText: String {
        // Known note-bearing fields by message type: error carries
        // `message`, continuation carries `summary`.
        message.content.stringValue
            ?? message.content["text"]?.stringValue
            ?? message.content["message"]?.stringValue
            ?? message.content["summary"]?.stringValue
