...
runSurfaceCapture({
  ...
  preparePage: async ({ page }) => {
    ...
    await page.context().route('**/api/conversations/svg-fixture/svg-artifacts/**', (route) => {
  ...
  captureStory: async ({ page, id, viewport, outDir }) => {
    ...
    try {
      ...
      await directPage.route('**/api/conversations/svg-fixture/svg-artifacts/**', (route) => route.fulfill({
