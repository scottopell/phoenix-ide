 ...
 */
state_updated_at: string, error?: ErrorPresentation, } | { "type": "llm_first_byte", sequence_id: number, request_id: string, } | { "type": "llm_attempt", sequence_id: number, attempt: number, max_attempts: number, reason: LlmAttemptReason, backing_off_ms: number, resets_at?: string, } | { "type": "token", sequence_id: number, text: string, request_id: string, } | { "type": "agent_done", sequence_id: number, } | { "type": "wake_contract_registered", sequence_id: number, workflow_id: number, contract_id: string, resource_kind: string, handle_id: string, expires_at: number, } | { "type": "wake_contract_terminal", sequence_id: number, workflow_id: number, contract_id: string, receipt_id: number, delivery_id: number, terminal_kind: WakeContractTerminalKind, } | { "type": "conversation_became_terminal", sequence_id: number, } | { "type": "conversation_update", sequence_id: number, conversation: unknown, } | { "type": "error", sequence_id: number, message: string,
/**
