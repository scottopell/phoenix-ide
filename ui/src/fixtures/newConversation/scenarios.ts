    ...
    recoveryRows: [
      {
        ...
        published_product_conversation_id: 'pc-delivery-failed',
      ...
      },
      {
        ...
        cwd: '/Users/qa/workspaces/failed-product',
        objective: 'Fix the creation failure',
        model: 'claude-sonnet-4-6',
        effort: 'medium',
        status: 'failed',
        updated_at: '2026-07-01T11:47:00Z',
        published_product_conversation_id: null,
        llm_language: 'phoenix-native',
        images: [],
        allowed_actions: ['delete', 'start_over'],
        last_error: 'Product creation could not allocate its worktree.',
      },
      {
        ...
        published_product_conversation_id: 'pc-delivery-pending',
        llm_language: 'phoenix-native',
