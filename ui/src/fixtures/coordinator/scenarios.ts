...
export const coordinatorScenarios = [
  ...
  { id: 'fleet-expanded', title: 'Fleet expanded', description: 'Touch-friendly expanded audit metadata.', initialView: 'fleet', working: false, expanded: true, fleetError: false },
