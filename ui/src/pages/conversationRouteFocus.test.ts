...
describe('decideRouteFocus', () => {
  const cases: ReadonlyArray<readonly [string, Partial<RouteFocusInputs>, RouteFocusState['decision']]> = [
    ...
    ['question panel / no composer preserves owner', { composerRenders: false, phase: { type: 'awaiting_user_response', request_id: 'test-question', tool_use_id: 'test-question', questions: [] } }, 'preserve-owner'],
