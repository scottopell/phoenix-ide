...
| [phoenix-guide-sync](phoenix-guide-sync/SKILL.md) | Audit the user guide (`docs/guide/`) for drift against code and specs ("is it true?"); auto-fix structural issues, propose tasks for the rest |
| [phoenix-guide-review](phoenix-guide-review/SKILL.md) | Quality-review the user guide against its North Star ("is it good?") — terseness, depth, precision, layer split; flags and proposes, never silently edits |
