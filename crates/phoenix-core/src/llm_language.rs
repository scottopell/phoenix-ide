...
pub const COORDINATOR_CONTINUATION_SYSTEM_PROMPT: &str =
    ...
    as a background monitor and has no ambient working directory. Existing authorized tools \
