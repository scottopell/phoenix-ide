...
| **REQ-CONV-003:** Message Composition | ✅ Complete | Auto-resize, draft persistence |
...
| **REQ-CONV-022:** Conversation View Density | ✅ Complete | `full`/`compact` via `DensityProvider`; compact collapses per-turn tools + short prose, no data loss |
