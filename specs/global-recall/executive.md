...
|---|---|---|
| **REQ-GR-001:** Provide Transparent Current Activity Facts | ✅ Complete | Each turn receives raw current-leaf state and timestamp facts without inferred work labels |
...
| **REQ-GR-005:** Provide Stable References and App-Local Links | ✅ Complete | Work, chain, conversation, and message references remain durable and resolvable |
...
The scope is transparent relational orientation, one durable chat-only Coordinator conversation, bounded global reads, singular text-message delivery to existing non-Coordinator conversations, and a compact read-only briefing action.
