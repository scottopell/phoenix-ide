...
| **AggregateLifecycleProjectionBroadcast** | Current lifecycle/metadata projection delivered through `conversation_update` on the conversation stream |
