...
| **AggregateLifecycleProjectionBroadcast** | ProductConversation Open/History lifecycle projected as the authoritative lifecycle fact on the root conversation stream |
