...
| **AggregateBoundLiveCarrierEnvelopeAllocated** | Closed aggregate-bound live envelope over the authoritative carrier set; excludes `init`, `conversation_hard_deleted`, and non-root-contract `work_scope_update` |
