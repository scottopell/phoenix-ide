...
| REQ-PD-016 | launchd disposable harness; Lima/VZ systemd success, rollback, initiator-death, and committed reboot recovery; detached bare-supervisor commit/rollback/stop acceptance; real Phoenix Linux runtime smoke remains outstanding |
