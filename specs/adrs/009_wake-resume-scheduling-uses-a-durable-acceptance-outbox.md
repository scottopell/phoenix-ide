...
- **Status:** Accepted
- **Date:** 2026-07-10
- **Supersedes:** ADR-008 for the guarantee that a persisted inbox observation alone makes resume scheduling idempotent
- **Affects:** REQ-WAKE-004, REQ-WAKE-005, REQ-WAKE-008, REQ-WAKE-012, `ResumeRequest`

## Context

ADR-008 separates durable terminal observations from their later LLM resume, but
...
- Superseded scheduling guarantee: ADR-008
