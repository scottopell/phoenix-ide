...
| [049](049_close-retirement-persists-writer-authority-and-atomically-adopts-retry-evidence.md) | Close retirement persists writer authority and atomically adopts retry evidence | Accepted | REQ-WL-002b/002c, REQ-BED-029, REQ-API-006; `AmbientWriterEvidenceRow`, `RetainedCleanupEvidenceAdoption` |
...
| Specifying Close ambient-writer evidence, post-retirement quiescence, exact-attempt retained cleanup adoption, or needs-repair recovery guidance | 048, then 042, 041, 040, 039, 034, 031, and 026 |
   ...
   └── establishes the shared ADR chain and incremental legacy-spec migration path
      ...
      └── ADR-026 (Product conversation lifecycle is separate from WorkScope resource ownership)
          ...
          └── ADR-031 (ProductConversation persistence uses staged single authority)
              ...
              ├── ADR-049 (Close retirement persists writer authority and atomically adopts retry evidence)
