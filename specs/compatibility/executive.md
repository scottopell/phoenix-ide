...
| REQ-COMP-003 | Production deployment implements runtime-artifact rollback only. Foundation acceptance covers manual offline paired restore; no general automatic database rollback subsystem exists. |
