...
| **REQ-LLM-008:** Request Observability | ✅ Complete | Spans-only OTLP allowlist, finite SDK limits, structured LLM/tool attributes, and content-free provider diagnostics; in-memory exporter and parser privacy regression tests |
