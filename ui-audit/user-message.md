...
**Component:** `ui/src/components/MessageComponents.tsx:136-173` **Type:** Core message
**Description:** User text + image attachments, with “You” label and sent-check.

## Screenshots

Stored at `ui-audit/screenshots/user-message/`.
