# Widget: tool-result-image

**Component:** `ui/src/components/MessageComponents.tsx:401-416, 463-471` **Type:** Tool
result **Description:** Base64 image display from `display_data` or parsed JSON result,
with media-type handling.

## Screenshots

Stored at `ui-audit/screenshots/tool-result-image/`.
